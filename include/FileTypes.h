...
// класс, объект которого хранит в себе набор типов файлов и подозрительных строк для каждого из них;
// предоставляет доступ к этим структурам;
// объект класса лежит внутри Dispatcher и используется для управления сканнерами и обработки результатов;
class FileTypes {
